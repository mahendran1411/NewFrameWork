...
//EX:7 Book a room by using POM ,Junit framework and get the input
//data from excel sheet and update the generated order no  in excel.
...
public class JunitTask7 extends BaseClass {
	@BeforeClass
